...
class sms_sts(protocol_packet_handler):
    ...
    def WriteTorqueEx(self, scs_id, torque):
        txpacket = [self.scs_loword(torque), self.scs_hiword(torque)]
        return self.writeTxRx(scs_id, SMS_STS_TORQUE_LIMIT, len(txpacket), txpacket)
